...
using Ngt.Center.Authorization.Ldap;
...
using Ngt.Center.DashboardCustomization.Definitions;
using Ngt.Center.Debugging;
using Ngt.Center.DynamicEntityParameters;
using Ngt.Center.Features;
using Ngt.Center.Friendships;
using Ngt.Center.Friendships.Cache;
using Ngt.Center.Localization;
using Ngt.Center.MultiTenancy;
using Ngt.Center.Net.Emailing;
using Ngt.Center.Notifications;
using Ngt.Center.WebHooks;

namespace Ngt.Center
{
    [DependsOn(
        typeof(CenterCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class CenterCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CenterLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CenterConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CenterMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CenterSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CenterCoreModule).GetAssembly());
        }
