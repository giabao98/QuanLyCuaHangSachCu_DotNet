...
{
    public class StripeGatewayManager : CenterServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Center";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CenterConsts.Currency;
        }
