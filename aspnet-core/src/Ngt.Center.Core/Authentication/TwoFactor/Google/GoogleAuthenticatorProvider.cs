...
namespace Ngt.Center.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CenterServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Ngt.Center", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
