...
namespace Ngt.Center.Web.Public.Startup
{
    [DependsOn(
        typeof(CenterWebCoreModule)
    )]
    public class CenterWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CenterWebFrontEndModule(IWebHostEnvironment env, CenterEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CenterWebFrontEndModule).GetAssembly());
        }
    }
}
