...
using Ngt.Center.EntityFrameworkCore.Repositories;

namespace Ngt.Center.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : CenterRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CenterDbContext> dbContextProvider)
