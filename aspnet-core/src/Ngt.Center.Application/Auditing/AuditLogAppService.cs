...
using Ngt.Center.Auditing.Exporting;
using Ngt.Center.Authorization;
using Ngt.Center.Authorization.Users;
using Ngt.Center.Dto;
using Ngt.Center.EntityHistory;
using EntityHistoryHelper = Ngt.Center.EntityHistory.EntityHistoryHelper;

namespace Ngt.Center.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CenterAppServiceBase, IAuditLogAppService
    {
