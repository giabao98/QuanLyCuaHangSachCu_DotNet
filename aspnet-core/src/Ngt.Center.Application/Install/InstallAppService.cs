...
using Ngt.Center.Migrations.Seed;
using Ngt.Center.Migrations.Seed.Host;
...
namespace Ngt.Center.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CenterAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CenterDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CenterConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CenterConsts.ConnectionStringName}", constring);
        }
