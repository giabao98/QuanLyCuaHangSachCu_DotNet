...
using Ngt.Center.DemoUiComponents.Dto;

namespace Ngt.Center.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CenterAppServiceBase, IDemoUiComponentsAppService
    {
