...
{
    public class SessionAppService : CenterAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CenterConsts.Currency,
                    CurrencySign = CenterConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CenterConsts.AllowTenantsToChangeEmailSettings,
