...
using Ngt.Center.Authentication.TwoFactor.Google;
using Ngt.Center.Authorization.Users.Dto;
using Ngt.Center.Authorization.Users.Profile.Cache;
using Ngt.Center.Authorization.Users.Profile.Dto;
using Ngt.Center.Friendships;
using Ngt.Center.Gdpr;
using Ngt.Center.Identity;
using Ngt.Center.Net.Sms;
using Ngt.Center.Security;
using Ngt.Center.Storage;
using Ngt.Center.Timing;

namespace Ngt.Center.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CenterAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Ngt.Center",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Ngt.Center",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
