...
using Ngt.Center.EntityDynamicParameterValues.Dto;

namespace Ngt.Center.DynamicEntityParameters
{
    [Authorize(AppPermissions.Pages_Administration_EntityDynamicParameterValue)]
    public class EntityDynamicParameterValueAppService : CenterAppServiceBase, IEntityDynamicParameterValueAppService
    {
