...
using Ngt.Center.Web.Authentication.JwtBearer;
using Ngt.Center.Web.Authentication.TwoFactor;
using Ngt.Center.Web.Chat.SignalR;
using Ngt.Center.Web.Configuration;
using Ngt.Center.Web.DashboardCustomization;

namespace Ngt.Center.Web
{
    [DependsOn(
        typeof(CenterApplicationModule),
        typeof(CenterEntityFrameworkCoreModule),
    ...
    public class CenterWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CenterWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CenterApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CenterWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CenterWebCoreModule).Assembly);
        }
