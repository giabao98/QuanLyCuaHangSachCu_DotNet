...
using Ngt.Center.Web.Areas.App.Startup;
...
namespace Ngt.Center.Web.Startup
{
    ...
    public class CenterWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CenterWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CenterWebMvcModule).GetAssembly());
        }
