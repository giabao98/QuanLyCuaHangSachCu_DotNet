...
namespace Ngt.Center.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class CenterScriptSrcTagHelper : TagHelper
    {
        ...
        public CenterScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
