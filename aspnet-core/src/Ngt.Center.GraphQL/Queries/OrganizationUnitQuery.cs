...
using Ngt.Center.Core.Base;
using Ngt.Center.Core.Extensions;
using Ngt.Center.Dto;
using Ngt.Center.Types;

namespace Ngt.Center.Queries
{
    public class OrganizationUnitQuery : CenterQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
