...
using MvvmHelpers;
using Ngt.Center.Authorization.Users.Profile;
using Ngt.Center.Authorization.Users.Profile.Dto;
using Ngt.Center.Commands;
using Ngt.Center.Core.Threading;
using Ngt.Center.Models.NavigationMenu;
using Ngt.Center.Services.Navigation;
using Ngt.Center.ViewModels.Base;
using Plugin.Media;
...
using Ngt.Center.ApiClient;
using Ngt.Center.Controls;
using Ngt.Center.Dto;
using Ngt.Center.Extensions;
using Ngt.Center.Localization;
using Ngt.Center.UI;
using Ngt.Center.UI.Assets;
using Ngt.Center.Views;
using DependencyResolver = Ngt.Center.Core.Dependency.DependencyResolver;

namespace Ngt.Center.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Center";
